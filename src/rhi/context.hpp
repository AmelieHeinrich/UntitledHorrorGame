...
public:
    ...
    static void UnbindGraphicsVertexConstantBuffer(i32 slot);
    static void UnbindGraphicsPixelConstantBuffer(i32 slot);
    static void UnbindGraphicsShaderResource(i32 slot);
    static void UnbindGraphicsSampler(i32 slot);

    static void BindComputePipeline(Ref<ComputePipeline> pipeline);
    static void BindComputeConstantBuffer(Ref<Buffer> buffer, i32 slot);
    static void BindComputeUnorderedViewTexture(Ref<Texture> texture, i32 slot);
    static void BindComputeUnorderedViewBuffer(Ref<Buffer> texture, i32 slot);
    static void BindComputeShaderResource(Ref<Texture> texture, i32 slot);
    static void BindComputeSampler(Ref<Sampler> sampler, i32 slot);
    static void UnbindComputeConstantBuffer(i32 slot);
    static void UnbindComputeUnorderedViewTexture(i32 slot);
    static void UnbindComputeUnorderedViewBuffer(i32 slot);
    static void UnbindComputeShaderResource(i32 slot);
    static void UnbindComputeSampler(i32 slot);

    static void BindBuffer(Ref<Buffer> buffer);

    static void Draw(u32 count);
    static void DrawIndexed(u32 count);
    static void Dispatch(u32 X, u32 Y, u32 Z);
